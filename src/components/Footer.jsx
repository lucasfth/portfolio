      ...
      <footer className='common-container'>
        <div className='inner-container'>
          ...
          <div className='social-links'>
            ...
            <a href="https://rdr.lucashanson.dk/gh" target="_blank" rel="noopener noreferrer">
              <img src="https://img.shields.io/badge/GitHub-24292F?logo=github" />
            </a>
            <a href="mailto:contact+wp@lucashanson.dk" target="_blank" rel="noopener noreferrer">
